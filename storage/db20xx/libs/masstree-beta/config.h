...
namespace Masstree {
/*start of self define*/
#define HAVE_INT64_T_IS_LONG_LONG 1
#define HAVE_INT64_IS_LONG 0
#define HAVE_INT64_IS_LONG_LONG 0
#define HAVE_MEMDEBUG 0
#define HAVE_INT64_TYPES 1
#define HAVE_STRING_PROFILING 0
#define HAVE_OPTIMIZE_SIZE 0
#define HAVE_OFF_T_IS_LONG_LONG 0
#define HAVE_SIZE_T_IS_UNSIGNED_LONG_LONG 0
#define __i386__ 0
#define PREFETCH_DEFINED 0
#define WORDS_BIGENDIAN 0
#define NOSUPERPAGE 0
...
#define MASSTREE_PACKAGE_VERSION "0.1"
...
#define FORCE_ENABLE_ASSERTIONS 0
